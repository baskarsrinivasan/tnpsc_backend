<div class="row align-items-center">
    ...
    <div class="col-sm-6">
        <div class="float-right d-none d-md-block">
            ...
            <a class="btn btn-primary waves-effect waves-light" href="<?php echo base_url(); ?>masters/exam_currentaffairs/add/">
...
datatable_init('<?php echo base_url(); ?>', '<?php echo $datatable; ?>', [
    ...
    {
        "data": "exam_currentaffairs"
    },
    {
        "data": "exam_currentaffairs_des"
    },
     {
        "data": "image",
...
function update_status(id) {
    Swal.fire({
        ...
        if (isConfirmed.value) {
            $.ajax({
                url: "<?php echo base_url(); ?>masters/exam_currentaffairs/change_status/" + id + "/",
                success: function(result) {
                    if (result) {
                        window.location('masters/exam_currentaffairs');
                    }
