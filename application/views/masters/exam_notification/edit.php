...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo base_url(); ?>masters/exam_notification/edit/<?php echo $default['id']; ?>"
    ...
    echo 'selected';
                    ...
                    <div class="form-group">
                        <label>Exam Name</label><span class="mandatory">*</span>
                        <input name="exam_notification_name" id="category" type="text" class="form-control" placeholder="Enter category Name"
                            value="<?php echo $default['exam_notification_name']; ?>">
                        <?php if (form_error('exam_notification_name')) {?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <?php echo form_error('exam_notification_name'); ?>
                        </div>
                        <?php }?>
                    </div>
                    <div class="form-group">
                        <label>اExam Description</label><span class="mandatory">*</span>
                        <textarea name="exam_notification_des" id="description" rows="4" cols="50" class="form-control summernote"
                            placeholder="Enter Description"><?php echo $default['exam_notification_des']; ?></textarea>
                       
                        <?php if (form_error('exam_notification_des')) {?>
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                            <?php echo form_error('exam_notification_des'); ?>
                        </div>
                        <?php }?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="user_file" id="exam_notification_des" type="file" class="form-control" placeholder="Exam Description"
                            >
