...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Create Exam Notification</h4>

                <form action="<?php echo base_url(); ?>masters/exam_notification/add" method="post" enctype="multipart/form-data">
                    <div class="row">
                          <div class="col-lg-6">
...
<div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input name="exam_notification_name" id="Exam" type="text" class="form-control" placeholder="Enter Exam Name"
                            required>
