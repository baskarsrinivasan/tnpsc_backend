<div class="row align-items-center">
    ...
    <div class="col-sm-6">
        <div class="float-right d-none d-md-block">
            ...
            <a class="btn btn-primary waves-effect waves-light" href="<?php echo base_url(); ?>masters/exam_questions/add/">
...
function delete_item(id) {
    Swal.fire({
        ...
        if (isConfirmed.value) {
            $.ajax({
                url: "<?php echo base_url(); ?>masters/exam_questions/delete/" + id + "/",
...
function update_status(id) {
    Swal.fire({
        ...
        if (isConfirmed.value) {
            $.ajax({
                url: "<?php echo base_url(); ?>masters/exam_questions/change_status/" + id + "/",
                success: function(result) {
                    if (result) {
                        window.location('masters/exams');
                    }
