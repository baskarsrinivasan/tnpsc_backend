<div class="row align-items-center">
    ...
    <div class="col-sm-6">
        <div class="float-right d-none d-md-block">
            ...
            <a class="btn btn-primary waves-effect waves-light" href="<?php echo base_url(); ?>masters/exam_study_material/add/">
...
datatable_init('<?php echo base_url(); ?>', '<?php echo $datatable; ?>', [
    ...
    {
        "data": "exam_study_material"
    },
    {
        "data": "exam_study_material_des"
    },
     {
        "data": "image",
...
function delete_item(id) {
    Swal.fire({
        ...
        if (isConfirmed.value) {
            $.ajax({
                url: "<?php echo base_url(); ?>masters/exam_study_material/delete/" + id + "/",
                success: function(result) {
                    if (result) {
                        window.location('masters/exam_study_material/');
                    }
                }
            });
...
function update_status(id) {
    Swal.fire({
        ...
        if (isConfirmed.value) {
            $.ajax({
                url: "<?php echo base_url(); ?>masters/exam_study_material/change_status/" + id + "/",
                success: function(result) {
                    if (result) {
                        window.location('masters/exam_study_material');
                    }
