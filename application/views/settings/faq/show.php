<div class="row align-items-center">
    ...
    <div class="col-sm-6">
        <div class="float-right d-none d-md-block">
            ...
            <a class="btn btn-primary waves-effect waves-light" href="<?php echo base_url(); ?>settings/faq/add/">
...
function delete_item(id) {
    Swal.fire({
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>settings/faq/delete/" + id + "/",
            success: function(result) {
                if (result) {
                    window.location('settings/faq');
                }
            }
        });
        if (result.value) {
