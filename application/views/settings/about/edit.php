...
<div class="row align-items-center">
    <div class="col-sm-6">
        <div class="page-title-box">
            <h4 class="font-size-18">Manage About</h4>
    ...
    <div class="col-sm-6">
        <div class="float-right d-none d-md-block">
            ...
            <a class="btn btn-primary waves-effect waves-light" href="<?php echo base_url(); ?>settings/about/">
                View About
            </a>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo base_url(); ?>settings/about/edit/<?php echo $default['id']; ?>" method="post">
